    ...
    render(){     
        ...
        <View style={{backgroundColor: '#CCDCED', marginBottom: 1, paddingTop:7 }} opacity={0.7}>                    
            <TouchableOpacity style={styles.main_container} 
                ...
                assMatItem.assMatKey,
                assMatItem.assMatId,
                assMatItem.assMatThumbnail,
                assMatItem.assMatFirstName,
                assMatItem.assMatLastName,
                assMatItem.assMatStreet,
                assMatItem.assMatCity
                )}>                    
            ...
            <View style={styles.userInfosWithoutAvatar}>
                <View style={{flex:1}}>
                    ...
                    {assMatItem.assMatFirstName} {assMatItem.assMatLastName}
                    </Text>
                    <Text style={styles.user_address}>{assMatItem.assMatStreet} - {assMatItem.assMatCity}</Text>
